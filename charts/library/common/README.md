...
Since a lot of charts follow a similar pattern, this library was built to reduce maintenance cost between the charts that use it and try achieve a goal of being DRY.
...
- name: common
  version: 4.5.1
  repository: https://home-ops.andrewmccall.com/
```

For more information, take a look at the [Docs](https://home-ops.andrewmccall.com/).
